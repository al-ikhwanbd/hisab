...
function reportShell(title,subtitle,body,landscape=false){
  ...
  *{box-sizing:border-box}body{margin:0;padding:24px;background:#fff;color:#17221f;font-family:Arial,"Noto Sans Bengali","Noto Sans",sans-serif}
  ...
  .table-wrap{width:100%;overflow-x:auto}table{width:100%;border-collapse:collapse;background:#fff}th,td{border:1px solid #c9d6d1;text-align:center;padding:4px 3px;font-size:10px;line-height:1.2;white-space:nowrap}th{font-weight:800;background:#f0f6f3}td.name,th.name{text-align:left;white-space:nowrap}.total-row td{font-weight:800;background:#f6faf8}.all-members-report-table{table-layout:fixed}.all-members-report-table .col-serial{width:4%}.all-members-report-table .col-name{width:18%}.all-members-report-table .col-total{width:8%}.all-members-report-table .col-due{width:8%}.all-members-report-table .col-year{width:15%}.all-members-report-table .col-month{width:5.2%}.all-members-report-table th:first-child,.all-members-report-table td:first-child{padding-left:1px;padding-right:1px}.all-members-report-table th.name,.all-members-report-table td.name{width:auto;white-space:nowrap;text-align:left;overflow:hidden;text-overflow:ellipsis}
...
function downloadAllMembersReport(){
  ...
  const body=`<div class="table-wrap"><table class="all-members-report-table yearly-report-table"><colgroup><col class="col-serial"><col class="col-name">${months.map(()=>'<col class="col-month">').join('')}<col class="col-total"><col class="col-due"></colgroup><thead><tr><th>ক্রমিক</th><th class="name">সদস্যের নাম</th>${months.map(m=>`<th>${m}</th>`).join('')}<th>মোট পরিশোধ</th><th>মোট বাকি</th></tr></thead><tbody>${rows}</tbody><tfoot><tr class="total-row"><td colspan="2">সর্বমোট</td>${monthTotals}<td>${money(totalPaid(y))}</td><td>${money(totalDue(y))}</td></tr></tfoot></table></div>`;
